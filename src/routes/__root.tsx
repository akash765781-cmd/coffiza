...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "shortcut icon", href: "/favicon.ico?v=20260904" },
      { rel: "icon", href: "/favicon.svg?v=20260904", type: "image/svg+xml" },
      { rel: "icon", href: "/favicon.ico?v=20260904", sizes: "any" },
      { rel: "icon", href: "/favicon-32x32.png?v=20260904", type: "image/png", sizes: "32x32" },
      { rel: "icon", href: "/favicon-16x16.png?v=20260904", type: "image/png", sizes: "16x16" },
      { rel: "apple-touch-icon", href: "/apple-touch-icon.png?v=20260904", sizes: "180x180" },
      { rel: "manifest", href: "/site.webmanifest?v=20260904" },
    ],
  }),
